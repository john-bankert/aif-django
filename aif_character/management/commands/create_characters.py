...
class Command(BaseCommand):
    ...
    def add_johns_characters(self):
        ...
        Skills.add_to_character(char, 'Concealed Carry', 'Class', 1)
        Skills.add_to_character(char, 'Imprint', 'Class', 1)
        Skills.add_to_character(char, 'Shuffle', 'Class', 1)
        Skills.add_to_character(char, 'Sleight of Hand', 'Class', 1)
        Skills.add_to_character(char, 'Vanish', 'Class', 1)
        Skills.add_to_character(char, 'Jewel Crafting', 'Racial', 1)
        Skills.add_to_character(char, 'Petriform', 'Racial', 1)
        Skills.add_to_character(char, 'Circle 1 Affinity', 'Spell', 2)
        Skills.add_to_character(char, 'Circle 1 Spell Group', 'Spell', 1)
        Skills.add_to_character(char, 'Circle 2 Affinity', 'Spell', 2)
        Skills.add_to_character(char, 'Short Sword', 'Weapon', 1)
        Skills.add_to_character(char, 'Unarmed Group', 'Armor', 1)
        Skills.add_to_character(char, 'Wool Robe', 'Armor', 1)
        # Weapons.add_to_character(char, 'Short Sword')
        Weapons.add_to_character(char, 'Dagger')
        Armor.add_to_character(char, 'armor', 'Wool Robe')
        Armor.add_to_character(char, 'helmet', 'Wizard Hat')
        char.add_container('Worn')
        char.add_equipment('Worn', 'Belt', 1, 10/1, 60, True, True)
        ...
        Skills.add_to_character(char, 'Melee', 'Class', 6)
        Skills.add_to_character(char, 'Missile', 'Class', 6)
        ...
        Skills.add_to_character(char, 'Bow Group', 'Weapon', 5)
        ...
        Skills.add_to_character(char, 'Buckler', 'Armor', 5)
