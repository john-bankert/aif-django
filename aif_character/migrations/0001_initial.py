...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('source_type', models.CharField(default='', max_length=10)),
                ('source_name', models.CharField(default='', max_length=75)),
                ('source_pk', models.IntegerField(default=0)),
                ('target_type', models.CharField(default='', max_length=10)),
                ('target_name', models.CharField(default='', max_length=75)),
